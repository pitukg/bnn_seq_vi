...
def get_task_specific_fns(task, data_info):
  if task == data_utils.Task.CLASSIFICATION:
    ...
    # predict_batch_size = 1_020  # want 1024 samples to be predicted together XXX TEMP change back to 1024
    ...
    predict_fn = get_softmax_predictions(num_batches=1)#data_info['train_shape'][0][1] // predict_batch_size)
    metrics_fns = {
